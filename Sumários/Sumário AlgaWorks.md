...
4. [[A anotação @Override]]
5. [[Chamando método da superclasse com super]]
6. [[Modificador final em classes e métodos]]
7. [[Sobrescrevendo o método Object.equals]]
##### Polimorfismo e classes abstratas
1. [[Entendendo o polimorfismo]]
2. [[Operador instanceof]]
3. [[Pattern Matching para o operador instaceof]]
4. [[Classes abstratas]]
5. [[Métodos abstratos]]
##### Interfaces
1. [[Criando a primeira interface]]
2. [[Nova interface e injeção de dependências]]
3. [[Métodos default em interfaces]]
4. [[Classes abstratas com interfaces]]
5. [[Métodos privados em interfaces]]
6. [[Métodos estáticos em interfaces]]
7. [[Implementando múltiplas interfaces]]
